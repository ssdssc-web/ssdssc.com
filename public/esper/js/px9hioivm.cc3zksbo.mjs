...
import { S as m, a as h, r as te, t as ne } from "./motion.bafvjhfu.mjs";
import {
  A as g,
  E as _,
  K as v,
...
function ce() {
  ...
  let t = null,
    n = !1;
  if (o.location.ancestorOrigins && o.location.ancestorOrigins.length > 0) {
    let e = o.location.ancestorOrigins[0];
    try {
      t = new URL(e).host;
    } catch {}
  ...
  return (t && (n = t === E || t.endsWith(`.${E}`)), n);
}
function le(e) {
  return c((t, n) => {
    let r = p(D, O, k),
      i = x.current() === x.canvas;
    return r && !i
      ? null
      : s(e, {
          ...t,
          ...
          onClick: (e) => {
            (e.preventDefault(),
              o.open(
                `https://www.framer.com/r/badge/?utm_campaign=freeplanbadge&utm_source=${encodeURIComponent(o?.location?.origin)}`,
              ));
          },
...
var E,
  ...
  fe = e(() => {
    (d(),
      ...
      (F = c((e, t) => {
        ...
        return n
          ? s(m.div, { ...a, layoutId: r, ref: t })
          : s(`div`, { ...a, ref: t });
      })),
      (I = ({ fill: e, fill2: t, height: n, id: r, width: i, ...a }) => ({
        ...a,
      ...
      (L = S(
        ...
        [
          `.framer-g7oZR { -webkit-mask-image: ${A}; -webkit-mask-position: ${N}; -webkit-mask-repeat: ${M}; -webkit-mask-size: ${P}; aspect-ratio: 9.7; background-color: var(--1bd4d3i); mask-image: ${A}; mask-mode: ${j}; mask-position: ${N}; mask-repeat: ${M}; mask-size: ${P}; width: 97px; }`,
        ],
        `framer-g7oZR`,
      )),
      (L.displayName = `Text`),
  ...
  pe = e(() => {
    (d(),
      v(),
      t(),
      (z = `url('data:image/svg+xml,<svg display="block" role="presentation" viewBox="0 0 12 20" xmlns="http://www.w3.org/2000/svg"><path d="M 0 0 L 12 0 L 12 6 L 6 6 Z M 0 6 L 6 6 L 12 12 L 6 12 L 6 18 L 0 12 Z" fill="var(--1bd4d3i, rgb(0, 0, 0))" height="18px" id="td4SVg2I8" transform="translate(0 1.5)" width="12px"/></svg>'), var(--framer-icon-mask, none)`),
      (B = `alpha, var(--framer-icon-mask-mode, add)`),
      (V = `no-repeat`),
      (H = `center`),
      (U = `auto`),
      (W = c((e, t) => {
      ...
      (G = ({ fill: e, fill2: t, height: n, id: r, width: i, ...a }) => ({
        ...a,
        vtL2DrqsL: t ?? a.vtL2DrqsL ?? `rgb(0, 0, 0)`,
        Z1QnXqTEb: e ?? a.Z1QnXqTEb ?? `rgb(0, 0, 0)`,
      })),
      (K = S(
        ...
        [
          `.framer-hcsc7 { -webkit-mask-image: ${z}; -webkit-mask-position: ${H}; -webkit-mask-repeat: ${V}; -webkit-mask-size: ${U}; aspect-ratio: 0.6; background-color: var(--1bd4d3i); mask-image: ${z}; mask-mode: ${B}; mask-position: ${H}; mask-repeat: ${V}; mask-size: ${U}; width: 12px; }`,
        ],
        `framer-hcsc7`,
      )),
      (K.displayName = `Framer`),
      (q = K),
      _(K, {
        Z1QnXqTEb: {
          defaultValue: `rgb(0, 0, 0)`,
...
e(() => {
  (d(),
    ...
    (J = y(q)),
    (Y = y(R)),
    (X = b(R, { nodeId: `pBR1Ew0r8`, override: ue, scopeId: `PX9hIOIVM` })),
    (me = T(
      w(b(m.a, { nodeId: `HK2sXlagE`, override: le, scopeId: `PX9hIOIVM` })),
    )),
    (he = `framer-6jWyo`),
    ...
    (Q = S(
      c(function (e, t) {
        let r = n(null),
          i = t ?? r,
          a = ee(),
          { activeLocale: o, setLocale: c } = se();
        oe();
        let { style: l, className: d, layoutId: f, variant: p, ...h } = Ce(e),
          {
            baseVariant: ne,
            classNames: _,
            ...
            children: s(Se, {
              ...
              children: s(ae, {
                ...
                children: u(me, {
                  ...
                  __targetOpacity: 1,
                  className: `${g(T, `framer-n0ccwk`, d, _)} framer-bmpgw8`,
    ...
    re(Q, [{ explicitInter: !0, fonts: [] }, ...J, ...Y], {
...
//# sourceMappingURL=PX9hIOIVM.Cc3ZKsBO.mjs.map
