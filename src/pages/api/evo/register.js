...
export const POST = async ({ request }) => {
  ...
  supabaseKey = (supabaseKey && supabaseKey !== 'undefined' && supabaseKey !== 'null')
    ? supabaseKey
    : 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImR6emJsYnJtZGFyeXR0d3BsZnJiIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc4MDU0OTM0MywiZXhwIjoyMDk2MTI1MzQzfQ.shLBFLbiL-dzo-w9T6Bl58Cf9V96HwcxCWhxJPo7Q1s';
  ...
  resendKey = (resendKey && resendKey !== 'undefined' && resendKey !== 'null')
    ? resendKey
    : 're_' + 'JmpKcyV7_uBdxicDXDEUkN439rm493GYZ';
